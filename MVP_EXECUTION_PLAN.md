...
- Completed: `0.1` application workspace, `0.2` configuration and secrets, and
  `0.3` durable local infrastructure.
- Remaining: 37 of 40 MVP tasks.
- Active next wave: Wave 2, trust boundary and durable schemas.
- Next completion target: `0.4`.
